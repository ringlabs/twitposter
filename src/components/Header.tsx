...
const Header = ({
  ...
  return <div className="w-full border-b border-gray-200 dark:border-gray-800 pb-4 mb-6 pt-4 bg-gray-50 dark:bg-gray-900 sticky top-0 z-50 py-[15px] rounded-b-md">
