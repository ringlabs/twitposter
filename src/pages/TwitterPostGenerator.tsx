...
const TwitterPostGenerator = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-twitter-extraLightGray dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
      <div className="container max-w-4xl mx-auto py-6 px-4 md:px-0">
        {!hasSelectedNiche ? (
