...
const TwitterPostGenerator = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-white to-twitter-extraLightGray dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
